...
export default function UpcomingAppointment() {
  ...
  return (
    <motion.div 
      ...
      className="max-w-5xl mx-auto px-4 mt-8 mb-4 relative z-20 w-full"
    >
      <div className="bg-gradient-to-r from-zinc-900 to-black border border-amber-500/30 rounded-2xl p-6 md:p-8 shadow-[0_0_30px_rgba(245,158,11,0.1)] relative overflow-hidden group min-h-[140px] flex items-center">
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 w-full md:w-auto">
              ...
              <div className="flex flex-col text-left">
                ...
                <h3 className="text-2xl font-serif text-white font-bold">{appointment.serviceName || 'Premium Salon Service'}</h3>
            ...
            <div className="flex flex-col sm:flex-row w-full md:w-auto gap-3 shrink-0">
               <Link 
                 ...
                 className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-zinc-900 border border-zinc-700 hover:bg-zinc-800 text-white font-bold uppercase tracking-wider text-sm rounded-xl transition-all"
               >
               ...
               <Link 
                 to="/dashboard"
                 onClick={() => triggerHaptic('light')}
                 className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-amber-500 hover:bg-amber-400 text-black font-bold uppercase tracking-wider text-sm rounded-xl transition-all shadow-[0_0_15px_rgba(245,158,11,0.1)] hover:shadow-[0_0_25px_rgba(245,158,11,0.3)] group/btn"
               >
                 Manage Booking
